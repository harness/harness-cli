...
func (h *AdapterArtifactHandler) CopyArtifact(source SourceRegistry, destination DestinationRegistry, artifact Artifact, destRegistry string) error {
...
func (b *adapterDestBridge) CreateRegistry(registry string) error {
	...
	_, err := b.adapter.CreateRegistry(registry, "generic")
	return err
}
