...
// newRegistryUpdateCmd wires up:
//
//	hns ar registry update
func newRegistryUpdateCmd() *cobra.Command {
	var host string
	cmd := &cobra.Command{
		Use:   "registry update",
		Short: "PUT /registry/{registry_ref}",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resp, err := cli.ModifyRegistry(context.Background())
			if err != nil {
				return err
			}
			fmt.Printf("%+v\n", resp)
...
func init() {
	ServiceCmd.AddCommand(newRegistryUpdateCmd())
}
