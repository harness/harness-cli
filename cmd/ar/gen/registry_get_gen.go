...
func newRegistryGetCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "registry get",
		Short: "GET /registry/{registry_ref}/artifact/{artifact}/version/{version}/files",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resp, err := cli.GetArtifactFiles(context.Background())
			if err != nil {
				return err
			}
			fmt.Printf("%+v\n", resp)
...
func init() {
	ServiceCmd.AddCommand(newRegistryGetCmd())
}
