...
func NewSetMetadataCmd(f *cmdutils.Factory) *cobra.Command {
  ...
  hc artifact set-metadata --registry r1 --package nginx --metadata "owner:team-a"

  # Version-level metadata
  hc artifact set-metadata --registry r1 --package nginx --version 1.2.3 --metadata "approved:true"`,
