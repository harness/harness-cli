...
func TestNewMetadataSetCmd(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args:       []string{"--registry", "test-reg", "--package", "nginx", "--metadata", "invalid"},
			wantErr:    true,
...
func TestNewMetadataGetCmd(t *testing.T) {
	config.Global = config.GlobalFlags{
		AccountID: "test-account",
	}
...
func TestNewMetadataDeleteCmd(t *testing.T) {
	config.Global = config.GlobalFlags{
		AccountID: "test-account",
	}
