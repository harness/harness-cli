...
const (
	ArtifactScanDetailsV3ScanStatusALLOWED ArtifactScanDetailsV3ScanStatus = "ALLOWED"
	ArtifactScanDetailsV3ScanStatusBLOCKED ArtifactScanDetailsV3ScanStatus = "BLOCKED"
	ArtifactScanDetailsV3ScanStatusUNKNOWN ArtifactScanDetailsV3ScanStatus = "UNKNOWN"
...
const (
	ALLOWED VersionScanStatus = "ALLOWED"
	BLOCKED VersionScanStatus = "BLOCKED"
	UNKNOWN VersionScanStatus = "UNKNOWN"
	WARN    VersionScanStatus = "WARN"
)
...
// ArtifactScanDetailsV3 Per-artifact synchronous bulk-evaluate result. Same shape as
// ArtifactScanDetails but scanStatus additionally allows ALLOWED and UNKNOWN,
// and id is always the zero UUID (no DB record is written).
type ArtifactScanDetailsV3 struct {
	...
	// Id Always the zero UUID for sync evaluations (no DB record)
	...
	// ParentRegistryId Parent registry ID (upstream chain)
	ParentRegistryId *openapi_types.UUID `json:"parentRegistryId,omitempty"`

	// ParentRegistryName Parent registry name (upstream chain)
	ParentRegistryName      *string                   `json:"parentRegistryName,omitempty"`
	PolicySetFailureDetails *[]PolicySetFailureDetail `json:"policySetFailureDetails,omitempty"`
	...
	// VersionId Version UUID (populated only if the artifact already exists in the DB)
	VersionId *openapi_types.UUID `json:"versionId,omitempty"`
}
...
// BulkScanEvaluateSyncRequest Request body for synchronous bulk evaluation
type BulkScanEvaluateSyncRequest struct {
	// Artifacts List of artifacts to evaluate (max 50)
	Artifacts []ArtifactScanInput `json:"artifacts"`

	// RegistryId Registry identifier (must be an upstream registry with firewall enabled)
	RegistryId openapi_types.UUID `json:"registryId"`

	// SkipCache If true, skip cached scan results and force fresh OPA evaluation
...
// BulkScanEvaluateSyncResponse defines model for BulkScanEvaluateSyncResponse.
type BulkScanEvaluateSyncResponse struct {
...
// BulkScanEvaluateSyncParams defines parameters for BulkScanEvaluateSync.
type BulkScanEvaluateSyncParams struct {
	// AccountIdentifier Unique identifier for the Harness account.
	AccountIdentifier AccountIdentifier `form:"account_identifier" json:"account_identifier"`
...
// BulkScanEvaluateSyncJSONRequestBody defines body for BulkScanEvaluateSync for application/json ContentType.
type BulkScanEvaluateSyncJSONRequestBody = BulkScanEvaluateSyncRequest
...
type ClientInterface interface {
	...
	// BulkScanEvaluateSyncWithBody request with any body
	BulkScanEvaluateSyncWithBody(ctx context.Context, params *BulkScanEvaluateSyncParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	BulkScanEvaluateSync(ctx context.Context, params *BulkScanEvaluateSyncParams, body BulkScanEvaluateSyncJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) AddBuildInfoWithBody(ctx context.Context, params *AddBuildInfoParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAddBuildInfoRequestWithBody(c.Server, params, contentType, body)
	if err != nil {
		return nil, err
	}
...
func (c *Client) InitiateBulkScanEvaluationWithBody(ctx context.Context, params *InitiateBulkScanEvaluationParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewInitiateBulkScanEvaluationRequestWithBody(c.Server, params, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) InitiateBulkScanEvaluation(ctx context.Context, params *InitiateBulkScanEvaluationParams, body InitiateBulkScanEvaluationJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewInitiateBulkScanEvaluationRequest(c.Server, params, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) BulkScanEvaluateSyncWithBody(ctx context.Context, params *BulkScanEvaluateSyncParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewBulkScanEvaluateSyncRequestWithBody(c.Server, params, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) BulkScanEvaluateSync(ctx context.Context, params *BulkScanEvaluateSyncParams, body BulkScanEvaluateSyncJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewBulkScanEvaluateSyncRequest(c.Server, params, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetBulkScanEvaluationStatus(ctx context.Context, evaluationId EvaluationIdParam, params *GetBulkScanEvaluationStatusParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetBulkScanEvaluationStatusRequest(c.Server, evaluationId, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewAddBuildInfoRequest(server string, params *AddBuildInfoParams, body AddBuildInfoJSONRequestBody) (*http.Request, error) {
	...
	return NewAddBuildInfoRequestWithBody(server, params, "application/json", bodyReader)
}
...
func NewAddBuildInfoRequestWithBody(server string, params *AddBuildInfoParams, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/build-info")
	if operationPath[0] == '/' {
...
func NewInitiateBulkScanEvaluationRequest(server string, params *InitiateBulkScanEvaluationParams, body InitiateBulkScanEvaluationJSONRequestBody) (*http.Request, error) {
	...
	bodyReader = bytes.NewReader(buf)
	return NewInitiateBulkScanEvaluationRequestWithBody(server, params, "application/json", bodyReader)
}
...
func NewInitiateBulkScanEvaluationRequestWithBody(server string, params *InitiateBulkScanEvaluationParams, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/scans/bulk-evaluate")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewBulkScanEvaluateSyncRequest calls the generic BulkScanEvaluateSync builder with application/json body
func NewBulkScanEvaluateSyncRequest(server string, params *BulkScanEvaluateSyncParams, body BulkScanEvaluateSyncJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewBulkScanEvaluateSyncRequestWithBody(server, params, "application/json", bodyReader)
}

// NewBulkScanEvaluateSyncRequestWithBody generates requests for BulkScanEvaluateSync with any type of body
func NewBulkScanEvaluateSyncRequestWithBody(server string, params *BulkScanEvaluateSyncParams, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/scans/bulk-evaluate-sync")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewGetBulkScanEvaluationStatusRequest(server string, evaluationId EvaluationIdParam, params *GetBulkScanEvaluationStatusParams) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/scans/bulk-evaluate/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// BulkScanEvaluateSyncWithBodyWithResponse request with any body
	BulkScanEvaluateSyncWithBodyWithResponse(ctx context.Context, params *BulkScanEvaluateSyncParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*BulkScanEvaluateSyncResp, error)

	BulkScanEvaluateSyncWithResponse(ctx context.Context, params *BulkScanEvaluateSyncParams, body BulkScanEvaluateSyncJSONRequestBody, reqEditors ...RequestEditorFn) (*BulkScanEvaluateSyncResp, error)
...
type BulkScanEvaluateSyncResp struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *BulkScanEvaluateSyncResponse
	JSONDefault  *V3Error
}

// Status returns HTTPResponse.Status
func (r BulkScanEvaluateSyncResp) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r BulkScanEvaluateSyncResp) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
func (c *ClientWithResponses) AddBuildInfoWithResponse(ctx context.Context, params *AddBuildInfoParams, body AddBuildInfoJSONRequestBody, reqEditors ...RequestEditorFn) (*AddBuildInfoResp, error) {
	rsp, err := c.AddBuildInfo(ctx, params, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseAddBuildInfoResp(rsp)
...
func (c *ClientWithResponses) InitiateBulkScanEvaluationWithBodyWithResponse(ctx context.Context, params *InitiateBulkScanEvaluationParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*InitiateBulkScanEvaluationResp, error) {
	rsp, err := c.InitiateBulkScanEvaluationWithBody(ctx, params, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseInitiateBulkScanEvaluationResp(rsp)
}
...
func (c *ClientWithResponses) InitiateBulkScanEvaluationWithResponse(ctx context.Context, params *InitiateBulkScanEvaluationParams, body InitiateBulkScanEvaluationJSONRequestBody, reqEditors ...RequestEditorFn) (*InitiateBulkScanEvaluationResp, error) {
	rsp, err := c.InitiateBulkScanEvaluation(ctx, params, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseInitiateBulkScanEvaluationResp(rsp)
...
// BulkScanEvaluateSyncWithBodyWithResponse request with arbitrary body returning *BulkScanEvaluateSyncResp
func (c *ClientWithResponses) BulkScanEvaluateSyncWithBodyWithResponse(ctx context.Context, params *BulkScanEvaluateSyncParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*BulkScanEvaluateSyncResp, error) {
	rsp, err := c.BulkScanEvaluateSyncWithBody(ctx, params, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseBulkScanEvaluateSyncResp(rsp)
}

func (c *ClientWithResponses) BulkScanEvaluateSyncWithResponse(ctx context.Context, params *BulkScanEvaluateSyncParams, body BulkScanEvaluateSyncJSONRequestBody, reqEditors ...RequestEditorFn) (*BulkScanEvaluateSyncResp, error) {
	rsp, err := c.BulkScanEvaluateSync(ctx, params, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseBulkScanEvaluateSyncResp(rsp)
...
func (c *ClientWithResponses) GetBulkScanEvaluationStatusWithResponse(ctx context.Context, evaluationId EvaluationIdParam, params *GetBulkScanEvaluationStatusParams, reqEditors ...RequestEditorFn) (*GetBulkScanEvaluationStatusResp, error) {
	rsp, err := c.GetBulkScanEvaluationStatus(ctx, evaluationId, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetBulkScanEvaluationStatusResp(rsp)
}
...
func ParseInitiateBulkScanEvaluationResp(rsp *http.Response) (*InitiateBulkScanEvaluationResp, error) {
	...
	response := &InitiateBulkScanEvaluationResp{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 202:
		var dest BulkScanEvaluationAccepted
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
...
// ParseBulkScanEvaluateSyncResp parses an HTTP response from a BulkScanEvaluateSyncWithResponse call
func ParseBulkScanEvaluateSyncResp(rsp *http.Response) (*BulkScanEvaluateSyncResp, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &BulkScanEvaluateSyncResp{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest BulkScanEvaluateSyncResponse
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
...
func ParseGetBulkScanEvaluationStatusResp(rsp *http.Response) (*GetBulkScanEvaluationStatusResp, error) {
	...
	response := &GetBulkScanEvaluationStatusResp{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest BulkScanEvaluationStatusResponse
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
