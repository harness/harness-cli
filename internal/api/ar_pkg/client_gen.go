...
func (c *Client) UploadDebianDebFileWithBody(ctx context.Context, accountId string, registry string, params *UploadDebianDebFileParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUploadDebianDebFileRequestWithBody(c.Server, accountId, registry, params, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UploadDebianDscFileWithBody(ctx context.Context, accountId string, registry string, params *UploadDebianDscFileParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUploadDebianDscFileRequestWithBody(c.Server, accountId, registry, params, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UploadDebianSrcFileWithBody(ctx context.Context, accountId string, registry string, params *UploadDebianSrcFileParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUploadDebianSrcFileRequestWithBody(c.Server, accountId, registry, params, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewUploadDebianDebFileRequestWithBody(server string, accountId string, registry string, params *UploadDebianDebFileParams, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/pkg/%s/%s/debian/deb", pathParam0, pathParam1)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewUploadDebianDscFileRequestWithBody(server string, accountId string, registry string, params *UploadDebianDscFileParams, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/pkg/%s/%s/debian/dsc", pathParam0, pathParam1)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewUploadDebianSrcFileRequestWithBody(server string, accountId string, registry string, params *UploadDebianSrcFileParams, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/pkg/%s/%s/debian/src", pathParam0, pathParam1)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type UploadDebianDebFileResp struct {
	Body         []byte
	HTTPResponse *http.Response
}
...
type UploadDebianDscFileResp struct {
	Body         []byte
	HTTPResponse *http.Response
}
...
type UploadDebianSrcFileResp struct {
	Body         []byte
	HTTPResponse *http.Response
}
...
func (c *ClientWithResponses) UploadDebianDebFileWithBodyWithResponse(ctx context.Context, accountId string, registry string, params *UploadDebianDebFileParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UploadDebianDebFileResp, error) {
	rsp, err := c.UploadDebianDebFileWithBody(ctx, accountId, registry, params, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUploadDebianDebFileResp(rsp)
}
...
func (c *ClientWithResponses) UploadDebianDscFileWithBodyWithResponse(ctx context.Context, accountId string, registry string, params *UploadDebianDscFileParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UploadDebianDscFileResp, error) {
	rsp, err := c.UploadDebianDscFileWithBody(ctx, accountId, registry, params, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUploadDebianDscFileResp(rsp)
}
...
func (c *ClientWithResponses) UploadDebianSrcFileWithBodyWithResponse(ctx context.Context, accountId string, registry string, params *UploadDebianSrcFileParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UploadDebianSrcFileResp, error) {
	rsp, err := c.UploadDebianSrcFileWithBody(ctx, accountId, registry, params, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUploadDebianSrcFileResp(rsp)
}
...
func ParseUploadDebianDebFileResp(rsp *http.Response) (*UploadDebianDebFileResp, error) {
	...
	response := &UploadDebianDebFileResp{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
func ParseUploadDebianDscFileResp(rsp *http.Response) (*UploadDebianDscFileResp, error) {
	...
	response := &UploadDebianDscFileResp{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
func ParseUploadDebianSrcFileResp(rsp *http.Response) (*UploadDebianSrcFileResp, error) {
	...
	response := &UploadDebianSrcFileResp{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
