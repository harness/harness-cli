...
const (
	...
	DISCOVERY_AGENT_CREATED        = "CLI Discovery Agent Created"
	DISCOVERY_AGENT_UPDATED        = "CLI Discovery Agent Updated"
	DISCOVERY_AGENT_DELETED        = "CLI Discovery Agent Deleted"
)
